...
def check_split_str(split_str):
	return re.match("((^|,)(\d+:\d+|\d+))+$",split_str)!=None
...
def expand_split_str(split_str):
	...
	for l in range(len(split_pr)):
		for i in range(split_po[l]-split_pr[l]+1):
...
def main():
	print check_split_str("1,2,3,4,5:7,27,28:31,32")
	x = reduce_split_str("1,2,3,4,5:7,27:30,31,32")
	print x
	y= expand_split_str("1:7,27:32")
	print y
